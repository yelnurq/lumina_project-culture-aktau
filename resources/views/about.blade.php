...
<div class="relative overflow-hidden bg-gradient-to-b from-sky-50 via-white to-amber-50">
    ...
    <section class="relative mx-4 md:mx-24 mt-[80px] mb-28 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div class="order-1 md:order-2 relative">
            ...
            <img src="/images/caspian_canyon.jpg" alt="Каспий и каньоны" 
    ...
    <section class="relative mx-4 md:mx-24 mb-28">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
            ...
            <div class="group bg-white/80 backdrop-blur-sm rounded-3xl shadow-lg hover:shadow-2xl transition p-8 text-center relative overflow-hidden">
                ...
                <img src="/images/culture.jpg" alt="Культура Маңғыстау" class="w-full h-52 object-cover rounded-2xl mb-5 shadow-md">
            ...
            <div class="group bg-white/80 backdrop-blur-sm rounded-3xl shadow-lg hover:shadow-2xl transition p-8 text-center relative overflow-hidden">
                <div class="absolute inset-0 bg-gradient-to-b from-sky-100/40 to-transparent opacity-0 group-hover:opacity-100 transition"></div>
                <img src="/images/hotels.jpg" alt="Отели Маңғыстау" class="w-full h-52 object-cover rounded-2xl mb-5 shadow-md">
            ...
            <div class="group bg-white/80 backdrop-blur-sm rounded-3xl shadow-lg hover:shadow-2xl transition p-8 text-center relative overflow-hidden">
                <div class="absolute inset-0 bg-gradient-to-b from-sky-100/40 to-transparent opacity-0 group-hover:opacity-100 transition"></div>
                <img src="/images/food.jpg" alt="Кухня Маңғыстау" class="w-full h-52 object-cover rounded-2xl mb-5 shadow-md">
    ...
    <section class="relative mx-4 md:mx-24 mb-28">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
            <div class="bg-white/80 backdrop-blur-sm rounded-3xl shadow-lg p-8 text-center hover:shadow-2xl transition">
                <img src="/images/author1.jpg" alt="Автор" class="w-28 h-28 mx-auto rounded-full mb-5 object-cover shadow-md border-4 border-sky-200">
            ...
            <div class="bg-white/80 backdrop-blur-sm rounded-3xl shadow-lg p-8 text-center hover:shadow-2xl transition">
                <img src="/images/author2.jpg" alt="Автор" class="w-28 h-28 mx-auto rounded-full mb-5 object-cover shadow-md border-4 border-sky-200">
                <h3 class="text-xl font-semibold text-gray-900 mb-2">Айжан Сарсен</h3>
                <p class="text-sky-700 font-medium mb-3">Исследователь и редактор</p>
                <p class="text-gray-600 text-[15px] leading-relaxed">
                    Пишет тексты, собирает истории и помогает услышать голос региона. 
                    Её слово — мост между культурой и современностью.
                </p>
            </div>

            <div class="bg-white/80 backdrop-blur-sm rounded-3xl shadow-lg p-8 text-center hover:shadow-2xl transition">
                <img src="/images/author3.jpg" alt="Автор" class="w-28 h-28 mx-auto rounded-full mb-5 object-cover shadow-md border-4 border-sky-200">
                <h3 class="text-xl font-semibold text-gray-900 mb-2">Ерлан Нурпеис</h3>
                <p class="text-sky-700 font-medium mb-3">Фотограф и видеограф</p>
                <p class="text-gray-600 text-[15px] leading-relaxed">
                    Передаёт свет, пыль и дыхание моря через объектив камеры. 
                    Его кадры оживляют пространство степей и каньонов.
                </p>
            </div>
        </div>
    </section>
